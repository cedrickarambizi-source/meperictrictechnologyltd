...
const TeamMemberCard = ({ member }: TeamMemberCardProps) => {
  ...
  return (
    ...
    >
      {/* Image */}
      <div className="relative overflow-hidden h-[300px] sm:h-[260px] lg:h-[280px] block">
        <img
          src={member.photo}
          alt={member.name}
          loading="lazy"
          ...
          style={{ objectPosition: 'center 30%', imageRendering: 'auto', backfaceVisibility: 'hidden' }}
        />
