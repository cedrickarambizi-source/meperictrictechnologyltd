  ...
  return (
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-1">
      <a
        ...
        aria-label="Facebook"
        className="flex items-center justify-center w-10 h-10 bg-[#12356e] text-white/70 hover:text-white hover:bg-[#12356e]/90 transition-all duration-300 rounded-l-lg"
      >
